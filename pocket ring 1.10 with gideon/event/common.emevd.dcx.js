...
$Event(0, Default, function() {
    ...
    InitializeEvent(0, 9947, 0); //Pokemon Catching And Rewarding Event
    InitializeEvent(0, 9948, 0); //Pokemon Share your talismans
    InitializeEvent(0, 9949, 0); //Pokemon Share your iframes
    InitializeEvent(0, 9005802, 0); //opt-in dyncam
    InitializeEvent(0, 9005801, 0); //opt-in dyncam
...
$Event(9947, Restart, function() { //Pokemon catching event, waits for the trigger, then iterates through
    SetEventFlagID(60110, ON);
    SetEventFlagID(710710, ON);
    SetEventFlagID(700550, ON);
    SetEventFlagID(69110, ON);
    if (!PlayerHasItemIncludingBBox(ItemType.Goods, 8158)) {
        SetEventFlagID(1034540010, ON);
        DirectlyGivePlayerItem(ItemType.Goods, 8158, 1034540010, 1);
    }
    const listPoke = [201000000,203000000,204000000,204100000,205000000,205100000,206000000,210000000,211000000,211010000,211090000,212000000,213000000,213100000,214000000,216000000,217000000,218000000,219000000,219100000,220000000,227000000,227100000,227200000,227400000,227500000,227600000,227700000,250000000,250090000,300000000,300040000,301000000,302000000,305000000,306000000,306100000,307000000,308000000,310000000,315000000,316000000,317000000,317090000,317100000,318000000,318100000,318110000,320000000,320090000,320100000,321000000,325000000,325100000,325200000,330000000,330020000,332000000,332090000,333000000,335000000,336000000,336010000,336020000,336100000,337000000,337100000,340000000,345000000,345100000,346000000,347000000,347150000,350000000,350020000,351000000,351010000,355000000,356000000,357000000,360000000,360010000,361000000,362000000,363000000,365000000,366000000,366100000,366200000,366210000,366400000,366500000,366600000,367000000,367080000,367090000,370000000,370100000,370110000,370200000,370210000,370220000,370230000,370300000,370310000,370400000,371000000,372000000,373000000,373010000,375000000,375010000,375020000,380000000,381000000,385000000,386000000,390000000,390110000,391000000,395000000,395010000,395020000,395030000,395040000,395090000,397000000,397010000,400000000,402000000,404000000,405000000,406000000,407000000,407100000,408000000,409000000,410000000,410100000,411000000,411090000,412000000,413000000,414000000,415000000,416000000,416100000,416200000,416300000,416400000,416500000,416600000,416700000,417000000,417100000,418000000,419000000,419100000,419200000,420000000,420100000,421000000,422000000,423000000,424000000,424100000,425000000,426000000,427000000,428000000,428100000,429000000,430000000,431100000,431120000,431200000,431400000,431500000,431600000,432100000,434000000,434100000,435100000,435200000,435300000,435400000,435500000,435600000,436100000,436200000,436300000,436400000,436500000,437100000,437200000,437300000,437400000,437500000,437600000,437700000,438000000,438100000,438200000,438300000,438500000,442000000,443000000,444000000,444100000,445000000,446000000,447000000,448000000,448100000,448200000,448300000,449000000,449090000,449100000,449190000,449200000,450000000,450400000,450500000,451000000,451100000,452000000,455000000,455040000,456000000,456100000,457000000,458000000,460000000,460010000,460080000,460100000,460300000,460400000,462000000,462010000,463000000,464000000,465000000,466000000,467000000,468000000,468010000,469000000,471000000,471010000,471100000,472000000,472100000,473000000,475000000,475100000,476000000,477000000,477020000,480000000,481000000,481100000,482000000,491000000,491100000,495000000,496000000,498000000,498010000,600100000,601000000,603100000,604000000,605000000,606000000,607000000,608000000,609000000,609100000,609110000,610000000,700000000,710000000,800000000,810000000,810100000,811000000,812000000,890100000];
    WaitFor(CharacterHasSpEffect(10000, 500611));
    WaitFixedTimeFrames(10);
    SetEventFlagID(1034540011, ON);
    for (let i = 0; i < listPoke.length; i++) {
        if (CharacterHasSpEffect(10000, listPoke[i], Equal)) {
            DirectlyGivePlayerItem(ItemType.Goods, listPoke[i] / 10000 + 200000, 1034540011, 1);
...
$Event(9948, Restart, function() { //Pokemon shares your talisman

    const listEffect = [3500,3501,3505,3506,3507,3512,3513,3515,3516,3517,3518,3519,3550,3551,3552,3553,3554,3555,3556,3557,3580,3581,3582,3583,3584,3603,3604,3605,3606,3607,3608,3609,3610,3611,3612,3613,3614,3615,3616,3617,3618,511009,511010,511011,511012,511014,511015,511016,511019,511026,511027,511028,511029,511030,511031,511060,511061,511062,511070,511071,511072,511073,511074,511075,511076,511077,511078,511079,511080,511081,1413000,1414000,1436000,1436100,1436101,1440000,1441000,1442000,1443100,1443101,1446000,1447000,1447001,1448000,1448001,1448002,1448003,1449000,1449001,1464000,1464010,1464020,1466000,1467000,1467001,1467002,1467005,1467006,1490000,1490001,1490010,1490090,1490091,1491000,1491001,1491010,1491090,1491091,1501000,1501001,1502000,1504000,1504001,1604000,1604001,1604002,1604003,1604004,1604005,1605000,1605001,1605002,1606000,1621000,1623000,1624000,1624010,1625000,1626000,1626001,1627000,1627001,1630000,1630001,1631000,1631001,1632000,1632001,1632002,1633000,1634000,1640000,1641000,1642000,1642001,1642100,1642101,1642200,1642201,1642300,1642301,1642400,1642401,1643000,1643001,1643100,1643101,1644000,1644001,1644100,1644101,1644102,1644103,1644104,1644105,1644110,1644111,1644112,1644113,1644114,1644115,1645000,1646000,1647000,1648000,1649000,1650000,1651000,1651001,1651002,1653000,1653001,1660000,1660001,1660002,1673000,1673001,1673002,1673003,1673004,1673005,1673006,1673007,1673008,1673009,1673010,1673011,1673012,1673013,1673014,1673020,1673021,1673022,1673023,1673024,1673025,1673026,1673027,1673028,1673029,1673030,1673031,1673032,1673033,1673034,1674000,1674001,1674002,1675000,1676000,1676005,1676006,1676007,1676008,1676009,1676010,1676011,1677000,1678000,1678001,1685000,1686000,1686001,1686002,1686003,1692100,1696000,1697000,1697001,1697002,1697010,1697100,1697101,1702000,1702100,1703000,1703100,1709000,1709001,1721000,1721001,1721002,1722000,1723000,1723001,1724000,1724001,1730000,1730001,1730002,1731000,1731001,1731002,1731003,1731100,1731101,1732000,1732001,1732002,1732003,1733000,1733001,1733002,1733005,1733006,1733007,1790000,1790001,1790002,1790003,1790010,1790011,1790012,1790300,600,601,602,603,604,605,606,607,608,609,610,611,612,613,614,615,616,617,618,619,620,621,622,623,624,625,626,627,628,629,630,631,632,633,634,635,636,637,638,639,640,641,642,643,644,645,646,647,648,649,650,651,652,653,654,655,656,657,658,659,501000, 501001, 501002, 501003, 501004, 501005, 501006, 501007, 501008, 501009, 501010, 501011, 501012, 310000,310010,310020,310100,310110,310120,310200,310210,310220,310300,310310,310320,310400,310401,310402,310410,310411,310412,310420,310421,310422,310500,310510,310600,310700,310800,310900,311000,311100,311400,311500,311600,311610,311700,311710,311800,311810,311900,311910,312000,312010,312100,312200,312210,312300,312310,312345,312355,312356,312500,312501,312502,312503,312504,312505,312506,312507,312508,320000,320100,320200,320300,320400,320500,320600,320700,320800,320801,320802,320803,320804,320805,320806,320807,320810,320811,320812,320813,320814,320815,320816,320817,320900,321000,321100,321200,321300,321400,321500,321600,321601,321700,321701,321800,321900,322000,322100,322200,330000,330010,330400,330500,330600,330700,330800,330801,330900,340000,340010,340020,340030,340100,340110,340120,340200,340210,340220,340300,340310,340320,340400,340410,340420,340500,340510,340520,340600,340700,340701,340800,340900,341000,341100,350000,350100,350200,350300,350301,350400,350401,350500,350501,350502,350600,350601,350602,360000,360100,360200,360400,360500,360600,360700,360800,360900,361000,361100,361101];

    for (let i = 0; i < listEffect.length; i++) {
        if (CharacterHasSpEffect(10000, listEffect[i], Equal)) {
            SetSpEffect(35000, listEffect[i]);
        } else {
            ClearSpEffect(35000, listEffect[i]);
        }
    }
    WaitFixedTimeFrames(30);
    RestartEvent();
});
$Event(9949, Restart, function() {
    WaitFor(CharacterHasSpEffect(10000, 5375));
    if (CharacterHasSpEffect(10000, 5375)) {
        SetSpEffect(35000, 5375);
    }
    WaitFixedTimeFrames(1);
    RestartEvent();
});
$Event(9005801, Restart, function() {
    SetNetworkSyncState(Disabled);
    WaitFor(!(CharacterHasSpEffect(10000, 6250010)
    || CharacterHasSpEffect(10000, 6250011)
    || CharacterHasSpEffect(10000, 6250012)
    || CharacterHasSpEffect(10000, 6250013)
    || CharacterHasSpEffect(10000, 6250014)
    || CharacterHasSpEffect(10000, 6250015)
    || CharacterHasSpEffect(10000, 6250016)
    || CharacterHasSpEffect(10000, 6250017)
    || CharacterHasSpEffect(10000, 6250018)
    || CharacterHasSpEffect(10000, 6250019)
    || CharacterHasSpEffect(10000, 6250110)
    || CharacterHasSpEffect(10000, 6250111)
    || CharacterHasSpEffect(10000, 6250112)
    || CharacterHasSpEffect(10000, 6250113)
    || CharacterHasSpEffect(10000, 6250114)
    || CharacterHasSpEffect(10000, 6250115)
    || CharacterHasSpEffect(10000, 6250116)
    || CharacterHasSpEffect(10000, 6250117)
    || CharacterHasSpEffect(10000, 6250118)
    || CharacterHasSpEffect(10000, 6250119)
    ));
    if (!CharacterHasSpEffect(10000, 6211732, Equal)) {
        ChangeCamera(-1, -1);
    }
    RestartEvent();
});
$Event(9005802, Restart, function() {
    SetNetworkSyncState(Disabled);
    WaitFor((CharacterHasSpEffect(10000, 6250010)
    || CharacterHasSpEffect(10000, 6250011)
    || CharacterHasSpEffect(10000, 6250012)
    ...
    || CharacterHasSpEffect(10000, 6250117)
    || CharacterHasSpEffect(10000, 6250118)
    || CharacterHasSpEffect(10000, 6250119)) && PlayerHasItemIncludingBBox(3, 2041)
    );
    if (!PlayerHasItemIncludingBBox(3, 2041)) {
        RestartEvent();
    }
    for (let x = 0; x < 10; x++) {
        if (CharacterHasSpEffect(10000, (6250010 + x), Equal)) {
            ChangeCamera((x + 10), (x + 10));
        }
    }
    if (CharacterHasSpEffect(10000, 6211732, Equal)) {
        for (let x = 0; x < 10; x++) {
            if (CharacterHasSpEffect(10000, (6250110 + x), Equal)) {
                ChangeCamera((x + 30), (x + 30));
            }
        }
    }
